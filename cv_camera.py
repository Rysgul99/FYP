...
class Camera():
    ...
    def frames(self):
        ...
        picam2.create_preview_configuration({"format": "BGR"})
        picam2.start()
        ...
        while True:
            ...
            #reduces the streaming img size for speed adjustment, 3-4 wokrs well
            img=cv2.resize(img,(int(width/self.rf),int(height/self.rf)))    
